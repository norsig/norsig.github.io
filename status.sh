...
MY_STATUS_TITLE="Status of Service"

# Link for the homepage button
MY_HOMEPAGE_URL="https://northernsignal.com"

# Shortcut to place the configuration file in a folder.
# Save it without / at the end.
MY_STATUS_CONFIG_DIR="/var/www/sites/status.norsig.com/public"
...
MY_STATUS_HTML="/var/www/sites/status.norsig.com/public/index.html"
...
MY_STATUS_STYLESHEET="bootstrap.min.css"
# A footer
MY_STATUS_FOOTER='&copy 2019 <a href="https://northernsignal.com">Northern Signal</a>, All Rights Reserved.'
...
<div class="page-header">
	<h1>
		<i class="ns ns-no1 ns-2x logo-text-blue"></i><br />$MY_STATUS_TITLE
...
<hr>
<footer>
	<small><p>$MY_STATUS_FOOTER</p>
	<p class="text-muted">$MY_DATE_TIME</p></small>
</footer>
